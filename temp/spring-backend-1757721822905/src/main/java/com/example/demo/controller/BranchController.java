...
public class BranchController {
    ...
    public ResponseEntity<List<BranchDTO>> getAll() {
        try {
            List<BranchDTO> list = service.findAll();
    ...
    public ResponseEntity<BranchDTO> getById(@PathVariable Long id) {
        try {
            Optional<BranchDTO> entity = service.findById(id);
    ...
    public ResponseEntity<BranchDTO> create(@Valid @RequestBody BranchDTO dto) {
        try {
            BranchDTO created = service.create(dto);
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<BranchDTO> partialUpdate(@PathVariable Long id, @RequestBody BranchDTO dto) {
        try {
            BranchDTO updated = service.partialUpdate(id, dto);
            return ResponseEntity.ok(updated);
        } catch (RuntimeException e) {
            return ResponseEntity.notFound().build();
        } catch (Exception e) {
