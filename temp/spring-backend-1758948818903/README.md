...
1. Navegar al directorio del proyecto:
   ```bash
   cd spring-backend-1758948818903
   ```
...
#### Persona - Ejemplos de Pruebas

**1. Obtener todos los persona**
- Método: GET
- URL: `{{baseUrl}}/persona`
- Headers: Ninguno
- Respuesta esperada: Lista de registros (puede estar vacía)

**2. Crear nuevo persona**
- Método: POST
- URL: `{{baseUrl}}/persona`
...
**4. Actualizar persona completamente**
- Método: PUT
- URL: `{{baseUrl}}/persona/1`
- Headers: `Content-Type: application/json`
- Body (raw JSON):
