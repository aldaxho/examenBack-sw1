...
class ClienteService {
  ...
  static const String _endpoint = 'cliente';
  ...
  static Future<Cliente> create(Cliente cliente) async {
    try {
  ...
  // Actualizar registro
  static Future<Cliente> update(int id, Cliente cliente) async {
    try {
  ...
  static Future<Cliente> partialUpdate(int id, Map<String, dynamic> updates) async {
    try {
  ...
  static Future<int> count() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Error al contar cliente: ${response.statusCode}');
      }
    } catch (e) {
      throw Exception('Error de conexión: $e');
    }
